...
public final class CompletionProposer {
    ...
    public static List<CompletionItem> propose(WorkspaceCompiler.Result compiled,
                                                String source,
                                                long offset,
                                                Index index,
    ...
    private static List<CompletionItem> proposeQualified(WorkspaceCompiler.Result compiled,
                                                          String source,
                                                          int dotOffset,
                                                          int cursor,
                                                          String prefix,
        ...
        WorkspaceCompiler.Result reparsed = speculativeReparse(compiled, source, dotOffset, cursor, index, classpath);
     ...
     */
    private static WorkspaceCompiler.Result speculativeReparse(WorkspaceCompiler.Result original,
                                                                String source,
                                                                int dotOffset,
                                                                int cursor,
                                                                Index index,
        ...
        try {
            return WorkspaceCompiler.compile(cu.getSourceFile().toUri(), patched, index, classpath);
        } catch (RuntimeException | Error e) {
            return null;
        }
    }
    ...
    private static List<CompletionItem> proposeUnqualified(WorkspaceCompiler.Result compiled,
                                                            CompilationUnitTree cu,
                                                            Trees trees,
                                                            int identifierStart,
                                                            int cursor,
